...
#ifndef TGS_TO_GIF_ZSTR_H
#define TGS_TO_GIF_ZSTR_H
	...
	public:
		...
		int deflate_loop(int flush) {
			while (true) {
				...
				std::streamsize sz = sbuf_p->sputn(out_buff, reinterpret_cast< decltype(out_buff) >(zstrm_p->next_out) -
				                                             out_buff);
